...
{
    public static class Distilation_Column_Simulation
    {
        ...
        public static void Run()
        {
            ...
            double[][] Hcoeffs =
            [
                [ -5.083, 1.287e-1, -7.503e-5, 1.230e-8, 1.282e4 ],
                [ -7.478, 1.501e-1, -8.849e-5, 1.420e-8, 1.975e4 ],
                [-10.021, 1.759e-1, -1.023e-4, 1.660e-8, 2.820e4 ],
                [-12.769, 2.031e-1, -1.194e-4, 1.940e-8, 3.840e4 ]
            ];

            double Cp(double T, double[] coeffs) =>
                coeffs[0] + (coeffs[1] + (coeffs[2] + coeffs[3]*T)*T)*T + coeffs[4]/Sqr(T);
