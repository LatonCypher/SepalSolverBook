...
{
    internal class Section_20_Exercise
    {
        public static void Run()
        {
            ...
            /// Complete the following methods. Each takes two integers as input and returns their sum, difference, product, and quotient.
            /// The fourth method "Divide" has been completed.
            /// For the usage, "Add" Method has been completed. you should complete the rest. 
            /// <code>
            /// {
            ...
            /// <code>
            /// {
            ///     // Implement a method that prompts the user to enter two integers 
            ///     // and then calls the arithmetic methods to display the results.
            ///     
            ...
            /// { 
            ///     Hint: Two options
            ///     Option 1: change to ``for`` loop, or 
            ///     Option 2: declare a iteration counter `int i = 0` and break when it equals the maximum iteration
            /// }
            /// </code>
            /// 
            /// 
