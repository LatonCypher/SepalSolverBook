...
namespace ConsoleApp1.TrainingFiles.Chapter_09_Numerical_Optimization
{
    internal class Section_2_Mixed_Integer_Linear_Programming
    {
        ...
        {
            /// <BookContent>
            /// /// <header 2> Mixed Integer Programming </header>
            ...
            ///
            /// <header 3> Fundamental Components of Mixed-Integer Linear Programming: </header 3>
            ///
            ...
            ///
            /// <header 3> Example 1: Basic Mixed-Integer Linear Program (MILP) </header 3>
