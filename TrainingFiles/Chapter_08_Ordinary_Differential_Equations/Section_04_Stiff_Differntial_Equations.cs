    ...
    internal class Section_04_Stiff_Differntial_Equations
    {
        public static void Run()
        {
            ...
            /// <code>
            {
                ...
                //Solve ODE
                (ColVec T, Matrix Y, _) = Ode43s(vdp2, [2, 0], [0, 6.3]);
                // Plot the result
                Plot(T, Y);
                Axis([0, 6.3, -10, 10]);
            ...
            /// <code>
            {
                ...
                //Solve ODE
                (ColVec T, Matrix Y, _) = Ode43s(robertson, [1, 0, 0], Logspace(-6, 6.6));
                // Plot the result
                Y[.., 1] = 1e4*Y[.., 1];
                SemiLogx(T, Y);
                Xlabel("Time t"); Ylabel("Soluton y");
            ...
            /// <code>
            {
                ...
                (ColVec T, Matrix Y, _) = Ode43s(robertson, [1, 0, 0], Logspace(-6, 6.6), opts);
            }
            /// </code>
            /// 
            /// <note>
