...
namespace ConsoleApp1.TrainingFiles.Chapter_11_Production_System_Modelling
{
    internal class Section_4_Nodal_Analysis
    {
        public static void Run()
        {
            ...
            /// </table>
            /// 
            /// <header 3> Stimulation Economics: A Nodal Analysis Case Study </header>
            ///
            /// **Problem Statement:**
            ...
            /// Reservoir Pressure(:math:`p_r`) | 2800 | psia 
            /// Bubble Point(:math:`p_b`) | 3000 | psia 
            /// Current Skin Factor(:math:`s_{ current}`) | +5 | dimensionless 
            /// Max Flow Rate(Ideal :math:`q_{ max}`) | 2000 | STB/day 
            /// Reservoir Radius / Wellbore Radius(:math:`r_e/r_w`) | 1000 | dimensionless 
            /// Well Depth | 4000 | ft 
            /// Oil Density | 55.0 | :math:`lb/ft^3` 
            /// Surface Pressure(:math:`p_{ surf}`) | 200 | psia 
            /// </table>
            /// 
            /// **Stimulation Offers:**
            /// 
