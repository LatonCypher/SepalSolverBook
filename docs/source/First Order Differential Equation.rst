...
- The Derivative :math:`\cfrac.. code-block:: csharp

   {dt}.. code-block:: csharp

   {dy}` Represents the "rate of change"(e.g., the speed of the car, how fast the room is cooling).
...
If you have an equation like :math:`\cfrac.. code-block:: csharp

   {dt}.. code-block:: csharp

   {dy} = y`, the equation is telling you: "The steeper the graph gets, the higher the value of y must be."
...
- example: For :math:`\cfrac.. code-block:: csharp

   {dt}.. code-block:: csharp

   {dy} = ky`, the analytical solution is  :math:`y(t) = Ce^.. code-block:: csharp
...
The Equation:  :math:`\cfrac.. code-block:: csharp

   {dt}.. code-block:: csharp

   {dy} = f(t, y)` (The rule of change), The Initial Condition:  :math:`y(0)=y_0 (The starting point). 
...
This guide covers the use of sepalsolver for solving an Initial Value Problem (IVP) defined by: math: `\frac.. code-block:: csharp

   {dy}.. code-block:: csharp

   {dt} = f(t, y), \quad y(t_0) = y_0`
...
.. math:: \frac.. code-block:: csharp

   {d^2y}.. code-block:: csharp
...
Let :math: `v = \cfrac.. code-block:: csharp

   {dy}.. code-block:: csharp

   {dt}`

hence :math: `\cfrac.. code-block:: csharp

   {dv}.. code-block:: csharp

   {dt} = -4y, y_0 = 0, v_0 = 5`

Now we have 2 equations :math: `\cfrac.. code-block:: csharp

   {dy}.. code-block:: csharp

   {dt} = v, \cfrac.. code-block:: csharp
